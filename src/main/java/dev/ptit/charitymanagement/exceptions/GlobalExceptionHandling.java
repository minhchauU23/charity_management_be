...
//    public ResponseEntity<APIResponse> httpMessageNotReadableExceptionHandling(HttpMessageNotReadableException exception, HttpServletRequest request){
...
//    }
    ...
    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<APIResponse> httpMessageNotReadableException(HttpMessageNotReadableException exception, HttpServletRequest request){
        ErrorCode errorCode = ErrorCode.BAD_REQUEST;
        ...
        APIResponse apiResponse = APIResponse.builder()
                ...
                .code(errorCode.getCode())
                .message("error")
                .errors(Map.of(errorCode.name(), "Invalid request payload"))
                .method(request.getMethod())
                .endpoint(request.getRequestURI())
                .build();
        return ResponseEntity.status(errorCode.getStatusCode()).body(apiResponse);
